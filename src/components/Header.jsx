...
import {getProductByNama, getAllProducts, clearProduct, clearAllProduct, getProductByIdSeller} from "../redux/actions/productsActions";
import {getTransactionBuyer, getTransactionSeller} from "../redux/actions/transactionsActions";
    ...
    return (
        <Container>
            <div className="navbar-component py-1">
                {["md"].map((expand) => (
                    <Navbar key={expand} expand={expand} className="navbar-body py-1" fixed="top">
                                        ...
                                        {!user ? (
                                                    ...
                                                    <InputGroup>
                                                        <Form onSubmit={handleSubmit}>
                                                            <div className="search-wrapper">
                                                                <Form.Control id="form-search" placeholder="Cari di sini ..." className="search-box-field" />
                                            ...
                                            <>
                                                ...
                                                <Dropdown>
                                                    ...
                                                    <Dropdown.Menu>
                                                        <Dropdown.Item onClick={handleBeranda}>Beranda</Dropdown.Item>
                                                        <Dropdown.Item onClick={handleDaftarJual}>Daftar Jual</Dropdown.Item>
                                                    </Dropdown.Menu>
                                                </Dropdown>
                                                {/* Notification */}
                                                <Dropdown>
                                                    ...
                                                    <Dropdown.Menu>
                                                        <Dropdown.Item onClick={handleTransaksi}>Transaksi</Dropdown.Item>
                                                        <Dropdown.Item>
                                                ...
                                                <Dropdown>
                                                    ...
                                                    <Dropdown.Menu>
                                                        <Dropdown.Item onClick={() => navigate("/profile")}>Akun Saya</Dropdown.Item>
